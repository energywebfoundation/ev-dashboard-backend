...
export class ClaimRepository extends DefaultCrudRepository<
  ...
  ClaimRelations
> {
  public readonly claimType: BelongsToAccessor<
    ClaimType,
    typeof Claim.prototype.id
  >;
  ...
  constructor(
    ...
    @repository.getter('ClaimTypeRepository')
    protected claimTypeRepositoryGetter: Getter<ClaimTypeRepository>,
  ) {
    super(Claim, dataSource);
    this.claimType = this.createBelongsToAccessorFor(
      'claimType',
      claimTypeRepositoryGetter,
    );
    this.registerInclusionResolver(
      'claimType',
      this.claimType.inclusionResolver,
    );
  }
}
