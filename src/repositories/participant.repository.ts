...
> {
  public readonly participantType: BelongsToAccessor<
    ParticipantType,
    typeof Participant.prototype.id
  >;
  ...
  constructor(
    ...
    @repository.getter('ParticipantTypeRepository')
    protected participantTypeRepositoryGetter: Getter<
      ParticipantTypeRepository
    >,
  ) {
    super(Participant, dataSource);
    this.participantType = this.createBelongsToAccessorFor(
      'participantType',
      participantTypeRepositoryGetter,
    );
    this.registerInclusionResolver(
      'participantType',
      this.participantType.inclusionResolver,
    );
  }
}
