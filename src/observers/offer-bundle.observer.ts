                ...
                this.offerRepository
                  ...
                  .then(recentOffers => {
                    ...
                    recentOffers.forEach((recentOffer: any) => {
                      ...
                      console.log(n + ' ' + _n);
                      console.log(
                        d.toLocaleString() + ' ' + _d.toLocaleString(),
                      );

                      if (
                        recentOffer.offerStateId ==
                          OFFER_STATE.PENDING_SUBMIT &&
                        _n == n &&
                        ...
                        if (constraint == null) {
                          ...
                          if (recentOffer.capacity <= constraint.limit) {
                            ...
                            if (
                              ...
                              windowCapacity =
                                windowCapacity + positiveCapacity;
                              // offerBundle.offers.push(recentOffer);
                              _recentOffers.push(recentOffer);
                            }
                          }
                        ...
                        .then(data => {
                          ...
                          setTimeout(() => {
                            this.offerBundleRepository
                              ...
                              .then((_offerBundle: any) => {
                                if (_offerBundle) {
                                  _offerBundle.offerBundleStateId =
                                    BUNDLE_STATE.ACCEPTED;
                                  this.offerBundleRepository.update(
                                    _offerBundle,
                                  );
                                  this.webSocket.emit(
                                    'offer/bundle/create',
